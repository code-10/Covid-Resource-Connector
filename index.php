...
<body style="font-family:'Poppins', sans-serif;">
		...
		<div class="container">
			...
			<h4 class="mt-4 responsive-md font-weight-bold">Welcome to Covid Resource Connector, <span class="responsive-itt">In association with ITT(In This Together)</span> 
