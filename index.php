...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
		...
		<div class="text-center m-2">
			...
			?>
			<h2 class="responsive-md mb-4">Want to Help? <a class="btn btn-success btn-sm" href="pages/requests.php?type=request" role="button">View Requests & Respond</a></h2>
			<h2 class="responsive-md mb-4">Find more <a class="btn btn-info btn-sm" href="pages/requests.php?type=resource" role="button">View All Available Resources</a></h2>
		</div>
