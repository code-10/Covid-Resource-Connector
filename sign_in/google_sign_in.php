...
if(!isset($_SESSION['access_token']))
{
 ...
 $login_button = '<a class="btn btn-light shadow p-3 mb-2 bg-white rounded" href="'.$google_client->createAuthUrl().'" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
